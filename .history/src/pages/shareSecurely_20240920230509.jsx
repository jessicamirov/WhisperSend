...
export default function ShareSecurely({ showMnemonicPopup, onConfirmMnemonic }) {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-r from-blue-500 to-indigo-500 dark:from-gray-800 :to-gray-900 relative">
            <div className="w-full max-w-4xl">
                <div className="bg-gray-800 p-6 rounded-xl shadow-2xl w-full transform transition duration-500 hover:scale-105 mb-8">
                    <PeerIdDisplay
