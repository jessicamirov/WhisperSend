...
/**
 * Decrypt component is responsible for decrypting files that the user has either:
 * 1. Encrypted previously on the Encrypt page, using a mnemonic.
 * 2. Received from a peer in the chat, which was encrypted with a shared key.
 * 
 * The decryption process uses the mnemonic to generate the wallet, and from there,
 * a shared secret is derived (using the peer's public key for chat files).
 * The component supports decrypting both chat files and non-chat files.
 * 
 * @param {Object} props - The component props.
 * @param {boolean} props.showMnemonicPopup - A flag to determine if the mnemonic popup should be shown.
 * @param {Function} props.onConfirmMnemonic - Callback to handle confirmation of the mnemonic.
 */
