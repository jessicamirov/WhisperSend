...
export default function Encrypt({ showMnemonicPopup, onConfirmMnemonic }) {
    ...
    // Adjust screen size and show instructions accordingly
    useEffect(() => {
        const handleResize = () => {
...
// Handle encryption of the selected file
// 1. Retrieve the public and private keys from PeerIdContext.
// 2. Read the file as an ArrayBuffer.
// 3. Encrypt the file using the public and private keys by encryptFile from encryption file.
// 4. Save the encrypted file along with the nonce and original file type as a JSON file for download.
