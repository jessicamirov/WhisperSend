 ...
 * 2. Use the nonce and shared secret to decrypt the message.
 * 3. Return the decrypted message as plain text, or "error" if decryption fails.
 */
...
/**
 * Encrypts a file using the recipient's public key and sender's private key.
 * 
 * Process:
 * 1. Derive a shared secret .
 * 2. Generate a nonce to ensure encryption uniqueness.
 * 3. Encrypt the file content using NaCl's `box.after` function with the shared secret and nonce.
 * 4. Return the encrypted file data, nonce, and file type.
 */
...
/**
 * Decrypts an encrypted file using the sender's public key and recipient's private key.
 * 
 * Process:
 * 1. Derive the shared secret using ECDH.
 * 2. Use the nonce and shared secret to decrypt the file.
 * 3. Return the decrypted file as a Blob, with the original or default MIME type.
 */
