/**
 * A general component used to display step-by-step instructions with a title and list of steps.
 * This component is designed to receive different instruction sets for various actions such as encryption, decryption, and chat.
 * For  Each page it woll display the corresponding instruction data.
 */
