...
export default function Header() {
    ...
    // Tracks screen width and updates the `isLargeScreen` state based on whether the screen is larger than 1024px
    useEffect(() => {
        const handleResize = () => {
    ...
    // Toggles the menu's visibility on small screens
    const toggleMenu = () => {
