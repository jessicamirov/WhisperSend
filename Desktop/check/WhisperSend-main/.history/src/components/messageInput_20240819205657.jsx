    ...
    return (
        <div className="flex items-center space-x-4">
            ...
            <button
                ...
                className="px-4 py-3 bg-blue-500 import { useContext } from "preact/hooks";
import { FaPaperclip, FaSmile } from "react-icons/fa";
import { handleSendMessage, handleSendFile } from "../utils/chatActions";
import { PeerIdContext } from "../components/peerIdContext";
...
text-white font-bold rounded-lg shadow-lg hover:bg-blue-600 transition duration-300"
            >
                Send
            </button>
        </div>
