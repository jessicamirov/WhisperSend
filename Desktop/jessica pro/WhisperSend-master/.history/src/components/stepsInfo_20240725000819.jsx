        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {steps.map(({ step, color, title, description }) => (
            <div className="flex flex-col items-center mb-4" key={step}>
              <div className={`w-12 h-12 rounded-full ${color} text-white flex items-center justify-center font-bold text-xl`}>{step}</div>
              <h4 className="text-xl font-bold text-gray-800 dark:text-gray-200 mt-4">{title}</h4>
